      ...
      <div class="uk-navbar-item">
        ...
        <oc-menu v-if="this.canUpload">
          ...
          <template slot="subnav">
            ...
            <oc-menu-item @click="createFolder = true" id="new-folder-btn" icon="create_new_folder" content="Create a new folder"></oc-menu-item>
            <oc-menu-item @click="createFile = true" id="new-file-btn" icon="save" content="Create a new file"></oc-menu-item>
          </template>
        </oc-menu>
